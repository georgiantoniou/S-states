...
# ./run_experiment.sh main simple_loop 5 180 /home/ganton12/data/exp3_pcu_congestions shasta c1e_0_20_50K "./simple_loop 180 50000" 0 20

# echo "sleep 10"
# sleep 10

# #take measurements for socket 0 cores 20 simple loop 100K active iterations
# ./run_experiment.sh main simple_loop 5 180 /home/ganton12/data/exp3_pcu_congestions shasta c1e_0_20_100K "./simple_loop 180 100000" 0 20

# echo "sleep 10"
# sleep 10

# #take measurements for socket 0 cores 20 simple loop 200K active iterations
# ./run_experiment.sh main simple_loop 5 180 /home/ganton12/data/exp3_pcu_congestions shasta c1e_0_20_200K "./simple_loop 180 200000" 0 20

# echo "sleep 10"
# sleep 10

# #take measurements for socket 0 cores 20 simple loop 400K active iterations
# ./run_experiment.sh main simple_loop 5 180 /home/ganton12/data/exp3_pcu_congestions shasta c1e_0_20_400K "./simple_loop 180 400000" 0 20

# echo "sleep 10"
# sleep 10

#take measurements for idle loops
./run_experiment.sh main idle 5 180 /home/ganton12/data/exp3_pcu_congestions shasta c1e_idle idle 0 20
