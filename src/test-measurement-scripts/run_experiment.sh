...
start_measurements () {
    ...
    ../measurements/dram_powermode_measurements.sh main 50 $USERNAME $PASSWD $HOST &
    python3 ../measurements/pdu.py $USERPDU $PASSWDPDU $HOSTPDU $2 &> $1/"pdu_"$3"_"$2".out" &
    ../measurements/turbostat_residency.sh main 10 5 $USERNAME $PASSWD $HOST &
...
stop_measurements () {
    ...
    ../measurements/dram_powermode_measurements.sh stop_measurements $PASSWD $USERNAME $HOST 
...
report_measurements () {
    ...
    ../measurements/dram_powermode_measurements.sh report_measurements $PASSWD $USERNAME $HOST &> $1/"dram_mode_"$2"_"$3".out"
